...
function addTask(newTask) {
  //create list of element and set its class
...
function onTaskComplete(btns) {
  btns.addEventListener("click", function (e) {
    var parent = e.target.closest(".task_item");
    if (parent) {
      parent.classList.add("task-complete");
      setTimeout(() => {
        parent.remove();
      }, 400);
      // ... rest of your code
    } else {
      console.log("Parent element is undefined or null");
    }
  });
}
